...
<body>
  <div class="jumbotron" style="background-color:white">
     <h1 class="text-center">Welcome to</h1>
      ...
      <h2 class="text-center">Welcome to Mid-hxn 07 on behalf of DevOps Academy , Now i make it as webhook , ATTEMPT 2 , NOW I COMPLETED THE DAY WITH ADDING CI-CD PIPELINE ...</h2>
